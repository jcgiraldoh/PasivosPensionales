...
from Funcion_final_compartidas import run_task
...
def index():
    ...
    <body>
        <h1><img src="/static/Vela.jpg" height="60px" width="60px"> Cálculo de Pasivos Pensionales Compartidas </h1>
        ...
        <ul class="elementor-icon-list-items elementor-inline-items">
            ...
            <li class="elementor-icon-list-item elementor-inline-item">
                ...
                <span class="elementor-icon-list-text">
                    <a href="mailto:juanjvelasquez@vela.com.co">juanjvelasquez@vela.com.co</a>
                </span>
            </li>
        </ul>
    </body>
